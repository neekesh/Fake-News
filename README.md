...
3. You will also need to download and install below 3 packages after you install either python or anaconda from the steps above
  ...
  - if you have chosen to install python  then run below commands in command prompt/terminal to install these packages
   ```
...
<p align="center">
  <img width="600" height="750" src="https://github.com/neekesh/Fake-News/blob/main/images/ProcessFlow.PNG">
</p>
...
<p align="center">
  <img width="550" height="450" src="https://github.com/neekesh/Fake-News/blob/main/images/LR_LCurve.PNG">
</p>

**Random Forest Classifier**

<p align="center">
  <img width="550" height="450" src="https://github.com/neekesh/Fake-News/blob/main/images/RF_LCurve.png">
</p>
